...
class TestCalculator(unittest.TestCase):
    ...
    def test_labels_update_correctly_numbers(self):
        self.calculator.press_numeric_button(".")
        self.calculator.press_numeric_button(1)
        self.calculator.press_numeric_button(2)
        self.calculator.press_numeric_button(3)
        self.calculator.press_numeric_button(4)
        self.calculator.press_numeric_button(5)
        self.calculator.press_numeric_button(6)
        self.calculator.press_numeric_button(7)
        self.calculator.press_numeric_button(8)
        self.calculator.press_numeric_button(9)
    ...
    def test_zero_div_error(self):
        self.calculator.press_numeric_button(1)
        self.calculator.use_operator_buttons("/")
        self.calculator.press_numeric_button(0)
        self.calculator.evaluate_equation()
