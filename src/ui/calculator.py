...
class Calculator:
    ...
    # Funktio luo ja palauttaa laskimen "vastausalueen" ja nappialueen
    ...
    def create_labels(self):
        equation_label = Label(self.display_area, text=self.equation, bg=self.color_light_gray, anchor=E, font=("Arial", 16), padx=20)
        answer_label = Label(self.display_area, text=self.answer_to_equation, bg=self.color_light_gray, anchor=E, font=("Arial", 40, "bold"), padx=20)
